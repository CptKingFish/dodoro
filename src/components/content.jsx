        ...
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
          <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
            ...
            <p className="mt-6 leading-7 text-gray-600">
              ...
              collaborations with companies, and fundraising efforts, we aim to
              provide these business owners with the resources and opportunities
              they need to lead better lives. Join us in making a positive
              impact on the backbone of our communities.
            </p>
          </div>
