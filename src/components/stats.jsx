...
const stats = [
  {
    ...
    nameB: "Orang-orang membuat perbedaan",
    value: "8,000+",
    icon: UserIcon,
  },
  {
    ...
    nameB: "Total dana yang terkumpul",
    value: "30M IDR",
  ...
  },
  {
    ...
    nameB: "Acara sukarelawan diadakan",
    value: "123",
    icon: FlagIcon,
  },
];
      ...
      <div className="relative mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-xl">
          ...
          <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">
            {lang.name !== "Bahasa" ? (
              ...
              <>Membuat perbedaan, selangkah demi selangkah</>
            )}
          </p>
          <p className="mt-6 text-lg leading-8 text-gray-300">
            {lang.name !== "Bahasa" ? (
              <>
                Join us and many other individuals in spreading kindness and
                making the world a better place.
              </>
            ) : (
              <>
                Bergabunglah dengan kami dan banyak orang lainnya dalam
                menyebarkan kebaikan dan membuat dunia menjadi tempat yang lebih
                baik.
              </>
            )}
          </p>
        ...
        <dl className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-10 text-white sm:mt-20 sm:grid-cols-2 sm:gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-4">
          {stats.map((stat) => (
            ...
            >
              <dt className="text-md leading-6">
                {lang.name !== "Bahasa" ? <>{stat.name}</> : <>{stat.nameB}</>}
              </dt>
