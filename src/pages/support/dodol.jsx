            ...
            <section aria-labelledby="information-heading" className="mt-4">
              ...
              <div className="mt-10 border-t border-gray-200 pt-10 space-y-6">
                ...
                <div className="mt-4 text-lg text-gray-800">
                  {lang.name !== "Bahasa" ? (
                    <>
                      <span>You can contact Ibu through:</span>
                      <div className="flex mb-1 text-end">
                        <PhoneIcon className="w-6 h-6 mt-1 mr-2" />
                        <span className="align-text-bottom">+123 45678</span>
                      </div>
                      <div className="flex">
                        <svg
                        ...
                        <span className="">mace.dodoro</span>
                      </div>
                    </>
                  ) : (
                    <>
                      <span>Anda dapat menghubungi Ibu melalui:</span>
                      <div className="flex mb-1 text-end">
                        <PhoneIcon className="w-6 h-6 mt-1 mr-2" />
                        <span className="align-text-bottom">+123 45678</span>
                      </div>
